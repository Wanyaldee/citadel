...
pub fn compile(manifest: bool) -> Result<(), Box<dyn std::error::Error>> {
    ...
    let (icon_filename, product_name) = match channel {
        "stable" => ("app-icon.ico", "Citadel"),
        "preview" => ("app-icon-preview.ico", "Citadel Preview"),
        "nightly" => ("app-icon-nightly.ico", "Citadel Nightly"),
        _ => ("app-icon-dev.ico", "Citadel Dev"),
    };
...
BEGIN
    ...
    BEGIN
        ...
        BEGIN
            ...
            VALUE "CompanyName", "Citadel Project\0"
            VALUE "LegalCopyright", "Copyright 2022 - 2025 Zed Industries, Inc.; Copyright 2026 Citadel Project\0"
        END
    END
    BLOCK "VarFileInfo"
    BEGIN
